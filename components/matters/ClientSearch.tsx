...
export default function ClientSearch({ organizationSlug, onSelect }: ClientSearchProps) {
    ...
    const timeoutId = window.setTimeout(async () => {
      ...
      try {
        const response = await fetch(
          `/api/clients/search?organization=${encodeURIComponent(organizationSlug)}&q=${encodeURIComponent(query)}`,
